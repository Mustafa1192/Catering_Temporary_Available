...
//       </h2>
//       <div className="review_box flex flex-col md:flex-row justify-center items-center gap-8">
...
//               />
//               <div>
//                 <p className="username text-sm font-semibold text-gray-800">{testimonial.name}</p>
//                 <p className="username text-xs text-gray-500">{testimonial.username}</p>
//               </div>
//             </div>
//           </div>
//         ))}
      ...
      <div className="relative flex justify-center">
        ...
        >
          {testimonials.map((testimonial) => (
            <div
              key={testimonial.id}
              className="each bg-gray-100 p-6 rounded-lg shadow-md shadow-2xl max-w-sm w-full md:w-80 flex-shrink-0"
            >
              <blockquote className="para text-gray-800 text-lg font-medium mb-6">
                <span className="block text-8xl text-gray-400 leading-none">“</span>
                {testimonial.quote}
